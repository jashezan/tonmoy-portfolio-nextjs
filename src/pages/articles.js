...
const FeaturedArticle = ({img, title, time, summary, link}) => {
    ...
    return (
        <li className="col-span-1 w-full p-4 relative bg-light border border-solid border-dark rounded-2xl dark:bg-dark
        dark:border-light">
            ...
            <span className="text-primary font-semibold dark:bg-primaryDark">{time}</span>
        </li>
    )
}
const articles = () => {
